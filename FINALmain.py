...
def game_start(welcomeScreen):
    ...
    welcomeScreen.fill("lightBlue")
    welcomeFont = pygame.font.Font(None, 75)

    # welcome button
    welcome = welcomeFont.render("Welcome", True, "black")
...
def display_win(screen):
    ...
    winMessage = winFont.render("You win!", True, "black")
