...
class SudokuGenerator:
    ...
    def __init__(self, row_length, removed_cells):
        ...
        # my edit for check_board - empty dict, rowcol:true val
    ...
    def remove_cells(self):
        ...
        while cells_to_remove > 0:
            ...
            if self.board[row][col] != 0:
                # my edit for check board - dict that saves the rowcol and true value
                self.removed_true_values[str(row)+str(col)] = self.board[row][col]
                self.board[row][col] = 0
                cells_to_remove -= 1
